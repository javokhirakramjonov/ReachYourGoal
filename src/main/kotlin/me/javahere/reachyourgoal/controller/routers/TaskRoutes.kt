...
class TaskRoutes(
	...
	@RouterOperation(
		...
		operation = Operation(
			operationId = "register", summary = "create task", requestBody = RequestBody(
	...
	@RouterOperation(
		produces = [MediaType.APPLICATION_JSON_VALUE],
		operation = Operation(
			operationId = "getAllTasks", summary = "get all tasks", responses = [ApiResponse(
				description = "tasks",
				responseCode = "200",
	...
	fun getAllTasks() = coRouter {
		GET("/tasks", taskRoutesHandler::getAllTasks)
	}

	@Bean
	@RouterOperation(
		produces = [MediaType.APPLICATION_JSON_VALUE], operation = Operation(
	...
	fun getTaskAttachmentsByTaskId() = coRouter {
	...
	fun downloadAttachmentByTaskIdAndAttachmentId() = coRouter {
	...
	fun uploadTaskAttachments() = coRouter {
	...
	fun deleteAttachmentByAttachmentId() = coRouter {
